...
urlpatterns=[
    ...
    url(r'^child_archives/get/$', views.get_child_archives, name='get child archives'),
    url(r'^child_archives/get2/(?P<child_id>.+)$', views.get_child_archives2, name='get child archives'),
    ...
    url(r'^newborns/get/$', views.get_newborns, name='get newborns'),
    ...
    url(r'^forty_two_days/get/$', views.get_forty_two_days, name='get forty_two_days'),
    ...
    url(r'^five_six_month/get/$', views.get_five_six_month, name='get five_six_month'),
    ...
    url(r'^one_year_old/get/$', views.get_one_year_old, name='get one_year_old'),
    ...
    url(r'^two_year_old/get/$', views.get_two_year_old, name='get two_year_old'),
    ...
    url(r'^three_year_old/get/$', views.get_three_year_old, name='get three_year_old'),
    ...
    url(r'^four_year_old/get/$', views.get_four_year_old, name='get four_year_old'),
    ...
    url(r'^five_year_old/get/$', views.get_five_year_old, name='get five_year_old'),
    ...
    url(r'^six_year_old/get/$', views.get_six_year_old, name='get six_year_old'),
    ...
    url(r'^query/result/$', views.result, name='result'),
]